    ...
    public partial class ApiContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductRatings>(entity =>
            {
                ...
                entity.Property(e => e.ThisDateTime).HasColumnType("datetime");
            });
            ...
            modelBuilder.Entity<WishListItems>(entity =>
            {
                entity.HasIndex(e => e.WishListId)
                    .HasName("IX_WishListId");

                entity.Property(e => e.Id).HasMaxLength(128);

                entity.Property(e => e.WishListId).HasMaxLength(128);

                entity.HasOne(d => d.WishList)
                    .WithMany(p => p.WishListItems)
                    .HasForeignKey(d => d.WishListId)
                    .HasConstraintName("FK_dbo.WishListItems_dbo.WishLists_WishListId");
            });
